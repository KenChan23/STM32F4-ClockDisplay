...
#define CS_LOW			GPIOE->BSRRH = CS_PIN
#define CS_HIGH			GPIOE->BSRRL = CS_PIN

#define WR_PIN			GPIO_Pin_1
#define WR_LOW			GPIOE->BSRRH = WR_PIN
#define WR_HIGH			GPIOE->BSRRL = WR_PIN

#define DA_PIN			GPIO_Pin_0
#define DA_LOW			GPIOE->BSRRH = DA_PIN
#define DA_HIGH			GPIOE->BSRRL = DA_PIN
...
GPIO_InitTypeDef  GPIO_InitStructure;
  ...
  GPIO_InitStructure.GPIO_Pin = CS_PIN;			// GPIO_Pin_2
  ...
  GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;		// Pull-up resistors ensure that inputs to logic systems settle at expected logic levels.
  GPIO_Init(GPIOE, &GPIO_InitStructure);
...
void HT1632::writedata(uint16_t d, uint8_t bits) {
  //pinMode(_data, OUTPUT);
	//DA_PIN.GPIO_Mode->GPIO_Mode_OUT
